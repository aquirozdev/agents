...
| Dify                  | Prompt, OpenAPI, configuración de proveedor y relay de identidad                                                       | Crear/publicar la aplicación y elegir modelo/proveedor                                                                          |
| Canales               | WhatsApp Cloud API con firma, conversación y deduplicación                                                             | Secrets de Meta, store compartido/cola y handoff humano                                                                         |
